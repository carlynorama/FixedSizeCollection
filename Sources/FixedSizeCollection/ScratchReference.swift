...
fileprivate extension FixedSizeCollection {
    ...
    static func rawBufferWork<T>(count:Int, initializer:T) {
    ...
    static func exampleAssembler<Header, DataType:Numeric>(header:Header, data:[DataType]) {
    ...
    static func processData<T>(data:Data, as type:T.Type) -> T {
    ...
    static func processData2<T>(data:Data, as type:T.Type, offsetBy offset:Int = 0) -> T {
        //precondition(offset % MemoryLayout<T>.stride == 0)
    ...
    static func processUnalignedData<T>(data:Data, as type:T.Type, offsetBy offset:Int = 0) -> T {
        let result = data.withUnsafeBytes { buffer -> T in
    ...
    static func processDataIntoArray<T>(data:Data, as type:T.Type, count:Int) -> [T] {
    ...
    static func processUnalignedDataIntoArray<T>(data:Data, as type:T.Type, byOffset offset:Int, count:Int) -> [T] {
    ...
    static func readNumericFrom<N:Numeric>(correctCountData data:Data, as numericType:N.Type) -> N {
    ...
    static func loadAsUInt8UseAsUInt32() {
...
fileprivate protocol HasMyNumber {
