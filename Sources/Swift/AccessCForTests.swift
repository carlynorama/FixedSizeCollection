...
extension FixedSizeCollection {
    ...
    static func rawBufferPointerPrint() throws {
        var testCollection = FixedSizeCollection<Int32>(5, default: 5)
        //Expected Failure. C function takes int* array
        //TODO: Check this against const void*
        //error: cannot convert value of type 'UnsafeRawBufferPointer' to expected argument type 'UnsafeMutablePointer<Int32>?'
        testCollection.withUnsafeBytes { pointer in
    ...
    static func mutableRawBufferPointerPrint() throws {
        var testCollection = FixedSizeCollection<Int32>(5, default: 5)
        //Expected Failure. C function takes int* array
        //TODO: Check against void*
        //error: cannot convert value of type 'UnsafeMutableRawBufferPointer' to expected argument type 'UnsafeMutablePointer<Int32>?'
        testCollection.withUnsafeMutableBytes { pointer in
            acknowledge_buffer(pointer, testCollection.count)
        }
    }
